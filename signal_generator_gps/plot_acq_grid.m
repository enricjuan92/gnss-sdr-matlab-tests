...
file=['/home/luis/dev/gnss-sdr/data/test_statistics_G_1C_sat_' num2str(sat) '_doppler_0.dat'];
...
for k=Doppler_min_Hz:Doppler_step_Hz:Doppler_max_Hz
    index=index+1;
    filename=['/home/luis/dev/gnss-sdr/data/test_statistics_G_1C_sat_' num2str(sat) '_doppler_' num2str(k) '.dat'];
...
xlabel('Doppler(Hz)');ylabel('Code Delay(samples)');title(['GLRT statistic of GPS Parallel Code Phase Search Acquisition. Local replica PRN ' num2str(sat)]);
